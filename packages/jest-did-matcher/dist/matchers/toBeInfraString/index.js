...
const passMessage = received => () => (0, _jestMatcherUtils.matcherHint)('.not.toBeInfraString', 'received', '') + '\n\n' + 'Expected value to not be of type INFRA string received:\n' + `  ${(0, _jestMatcherUtils.printReceived)(received)}`;

const failMessage = received => () => (0, _jestMatcherUtils.matcherHint)('.toBeInfraString', 'received', '') + '\n\n' + 'Expected value to be of type INFRA string:\n' + `  ${(0, _jestMatcherUtils.printExpected)('type of INFRA string')}` + 'Received:\n' + `  ${(0, _jestMatcherUtils.printReceived)(received)}`;
